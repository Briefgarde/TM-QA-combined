...
def assemble_context(
    ...
    Args:
        ...
        max_context_tokens  : Maximum number of tokens allowed for the prompt context,
                              leaving headroom in the model's context window for generation.
    ...
    for sentence in sentence_pool:
        ...
        context_token_count = len(tokenizer.encode(candidate_prompt, add_special_tokens=False))
...
def assemble_context_dataset(
    ...
    Args:
        ...
        max_context_tokens : Token budget for the prompt context.
        prompt_template    : Format string with {context} and {query} placeholders.
